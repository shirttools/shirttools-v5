...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
    		...
    		{
    			$designable_status = $this->model_shirttools_designable->checkDesignable($product_id);
    			$grid_preview = makeGridProduct($this->data['options'], $designable_status);
    		}
    		else
    		{
    			$designable_status = '';
    		...
    		$this->data['designable_status'] = $designable_status;
    		/* Shirttools.com */

			$this->data['grid_preview'] = $grid_preview;
			$this->data['shirttools_color'] = $shirttools_color;
			$this->data['shirttools_size'] = $shirttools_size;
			...
			{
				$shirttools_preview = getShirttoolsPreview($_REQUEST['design_id']);
				$this->data['shirttools_preview'] = $shirttools_preview;
			}
			else
			{
				$this->data['shirttools_preview'] = array();
			}
			/* Shirttools.com */
