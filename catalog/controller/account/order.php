...
class ControllerAccountOrder extends Controller {
	...
	public function info() { 
		...
		if ($order_info) {
			...
			foreach ($products as $product) {
	    		...
	    		{
	    			$grid_preview = makeGrid($options, 'order_info');
	    		}
	    		else
	    		{
	    			$grid_preview = '';
	...
	public function design() { 
		...
		if ($order_info) {
			...
			$this->data['column_name'] = $this->language->get('column_name');
			$this->data['column_side1'] = $this->language->get('column_side1');
			$this->data['column_side2'] = $this->language->get('column_side2');
			$this->data['column_side3'] = $this->language->get('column_side3');
			$this->data['column_side4'] = $this->language->get('column_side4');
			...
			foreach ($products as $product) {				
				...
				$this->data['products'][] = array(
					'name'     => $product['name'],
					'design'   => $this->model_account_order->getProductDesign($product['product_id'], $this->request->get['order_id'])
				);
			}

			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/order_design.tpl')) {
				$this->template = $this->config->get('config_template') . '/template/account/order_design.tpl';
			} else {
				$this->template = 'default/template/account/order_design.tpl';
			}
