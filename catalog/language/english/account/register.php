...
$_['text_account_already'] = 'Create an account so we can save your designs and you can use them again.<br><br>You will be able to shop faster, be up to date on an order\'s status, and keep track of the orders you have previously made.<br><br>If you already have an account with us, please login at the <a href="%s">login page</a>.';
