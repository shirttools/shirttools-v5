...
<div style="width: 680px;"><a href="<?php echo $store_url; ?>" title="<?php echo $store_name; ?>"><img src="<?php echo $logo; ?>" alt="<?php echo $store_name; ?>" style="margin-bottom: 20px; border: none;" /></a>
  ...
  <!--Shirttools.com -->
  <p style="margin-top: 0px; margin-bottom: 20px;"><a href="<?php echo HTTP_SERVER ?>index.php?route=account/order/design&order_id=<?php echo $order_id ?>"><?php echo $text_view_design; ?></a></p><br>
  <!--Shirttools.com -->
  <?php } ?>
  <?php if ($download) { ?>
