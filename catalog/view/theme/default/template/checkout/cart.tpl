        ...
        <tbody>
          ...
          <tr>
            <td class="image"><?php if ($product['thumb']) { ?>
              ...
              <!--  Shirttools.com -->
              <?php
              if(isset($product['shirttools_preview']))
              {
                foreach ($product['shirttools_preview'] as $key => $value) {
                  if($value != '')
                  {
                    echo "<br><a class='colorbox' target='_blank' href='$value'><img width='45' src='$value'></a>";
                  }
                }
              }
              ?>
            ...
            <td class="quantity">
              <?php if(empty($product['shirttools_preview']) && empty($product['grid_preview'])) { ?>
