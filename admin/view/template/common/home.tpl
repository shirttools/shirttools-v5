...
<div id="content">
  ...
  <!-- Shirttools -->
  <?php
    require(DIR_APPLICATION.'/controller/shirttools/update.php');
    if((time() - Designer_getSetting('cron_last_run')) > 120)
    {
      echo '<div class="alert alert-danger"><p class="lead">'.$this->language->get("text_cron_error").'</p></div>';
    }
  ?>  
  <!-- Shirttools -->
  ...
  <div class="box">
    ...
    <div class="content">
      ...
      <!-- Shirttools -->
      <?php require(DIR_APPLICATION.'/controller/shirttools/news.php'); ?>
      <!-- Shirttools -->
    </div>
  </div>
</div>
