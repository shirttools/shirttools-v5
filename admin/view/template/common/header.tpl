...
<!--Shirttools.com -->
<?php if(isset($this->request->get['route']) && $this->request->get['route'] != 'module/journal2') {?>
<script type="text/javascript" src="view/javascript/bootstrap/js/bootstrap.js?v=<?php echo $version; ?>"></script>
<script type="text/javascript" src="view/javascript/shirttools.js?v=<?php echo $version; ?>"></script>

<?php if(isset($this->request->get['route']) && $this->request->get['route'] != 'module/journal_cp') {?>
<link href="view/javascript/bootstrap/css/bootstrap.css?v=<?php echo $version; ?>" rel="stylesheet" media="screen" />
<?php } ?>
<link href="view/javascript/font-awesome/css/font-awesome.min.css?v=<?php echo $version; ?>" type="text/css" rel="stylesheet" />
<link href="view/stylesheet/shirttools.css?v=<?php echo $version; ?>" rel="stylesheet" media="screen" />

<script type="text/javascript" src="view/javascript/colorbox/jquery.colorbox.js"></script>
<link href="view/javascript/colorbox/colorbox.css" rel="stylesheet" />
<?php } ?>
<!--Shirttools.com -->
...
<div id="container">
  ...
  <div id="menu">
    <ul class="left" style="display: none;">
      ...
      <li id="shirttools"><a class="top"><?php echo $text_shirttools; ?></a>
       <ul>
         <li><a href="<?php echo $clip_art_category; ?>"><?php echo $text_clip_art_category; ?></a></li>
         <li><a href="<?php echo $clip_art; ?>"><?php echo $text_clip_art; ?></a></li>
         <li><a href="<?php echo $fonts; ?>"><?php echo $text_fonts; ?></a></li>
         <li><a href="<?php echo $google_fonts; ?>"><?php echo $text_google_fonts; ?></a></li>
         <li><a href="<?php echo $designable_product; ?>"><?php echo $text_designable_product; ?></a></li>
         <li><a href="<?php echo $shirttools_colors; ?>"><?php echo $text_shirttools_colors; ?></a></li>
         <li><a href="<?php echo $shirttools_setting; ?>"><?php echo $text_shirttools_setting; ?></a></li>
         <li><a href="<?php echo $link_language; ?>"><?php echo $text_menu_language; ?></a></li>
       </ul>
      </li>
