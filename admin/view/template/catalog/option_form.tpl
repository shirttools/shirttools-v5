...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a class="youtube button hide" href="http://www.youtube.com/v/Gpcl6CZHALE?rel=0&amp;wmode=transparent&amp;autoplay=1"><?php echo $this->language->get('button_video_tutorial'); ?></a><a onclick="$('#form').submit();" class="button"><?php echo $button_save; ?></a><a href="<?php echo $cancel; ?>" class="button"><?php echo $button_cancel; ?></a></div>
    </div>
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form" id="form-option">
          <tr>
...
function addOptionValue() {
  ...
  if($("#form #form-option input").val() == 'ST-Color')
  {
    $("#form #form-option").addClass('hide');
    $("#form #option-value tr td:nth-child(2)").addClass('hide');
    $("#form #option-value tfoot tr td:nth-child(1)").addClass('hide');
    $("#form #option-value tfoot tr td:nth-child(2)").removeClass('hide');
  }
}
//--></script> 
<script type="text/javascript"><!--
