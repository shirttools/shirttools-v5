  ...
  <div class="box">
    ...
    <div class="content">
      <div class="vtabs"><a href="#tab-order"><?php echo $tab_order; ?></a><a href="#tab-payment"><?php echo $tab_payment; ?></a>
        ...
        <a href="#tab-artworks"><?php echo $this->language->get('tab_artworks'); ?></a>
        <a href="#tab-user_upload"><?php echo $this->language->get('tab_user_upload'); ?></a>
        <?php if ($maxmind_id) { ?>
        <a href="#tab-fraud"><?php echo $tab_fraud; ?></a>
        <?php } ?>
      </div>
      <div id="tab-user_upload" class="vtabs-content">
        <?php echo getUploadDetails($order_id); ?>
      </div>
      <div id="tab-artworks" class="vtabs-content">
        <?php echo getArtworkDetails($order_id); ?>
      </div>
          ...
          <tbody>
            ...
            <tr>
              <td class="left"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
                <?php echo $product['grid_preview'] ?>
                <?php foreach ($product['option'] as $option) { ?>
                <br />
                <?php if ($option['type'] != 'file') { ?>
                  <?php if($option['name'] != 'ST-Grid-Color' && $option['name'] != 'ST-Grid-Size' && $option['name'] != 'ST-Extra-Print-Price' && $option['name'] != 'ST-Color') { ?>
